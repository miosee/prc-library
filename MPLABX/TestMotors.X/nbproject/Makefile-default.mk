...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/TestMotors.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../PrcLib/AnaIn.c ../PrcLib/DigIn.c ../PrcLib/LEDs.c ../PrcLib/Motors.c ../PrcLib/PRC.c ../PrcLib/AMB2300.c ../PrcLib/clock.c ../PrcLib/uart1.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1811990669/AnaIn.o ${OBJECTDIR}/_ext/1811990669/DigIn.o ${OBJECTDIR}/_ext/1811990669/LEDs.o ${OBJECTDIR}/_ext/1811990669/Motors.o ${OBJECTDIR}/_ext/1811990669/PRC.o ${OBJECTDIR}/_ext/1811990669/AMB2300.o ${OBJECTDIR}/_ext/1811990669/clock.o ${OBJECTDIR}/_ext/1811990669/uart1.o ${OBJECTDIR}/main.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1811990669/AnaIn.o ${OBJECTDIR}/_ext/1811990669/DigIn.o ${OBJECTDIR}/_ext/1811990669/LEDs.o ${OBJECTDIR}/_ext/1811990669/Motors.o ${OBJECTDIR}/_ext/1811990669/PRC.o ${OBJECTDIR}/_ext/1811990669/AMB2300.o ${OBJECTDIR}/_ext/1811990669/clock.o ${OBJECTDIR}/_ext/1811990669/uart1.o ${OBJECTDIR}/main.o

# Source Files
SOURCEFILES=../PrcLib/AnaIn.c ../PrcLib/DigIn.c ../PrcLib/LEDs.c ../PrcLib/Motors.c ../PrcLib/PRC.c ../PrcLib/AMB2300.c ../PrcLib/clock.c ../PrcLib/uart1.c main.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/TestMotors.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/TestMotors.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/TestMotors.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -Wl,,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/TestMotors.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/TestMotors.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/TestMotors.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
